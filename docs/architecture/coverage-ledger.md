...
| S2 Ripping and SCSI | `CUETools.Ripper*/`, `Bwg.*/` | high | commented, tested | legacy-unclear / hardware boundary | verified: C2 accumulation/voting invariants reviewed; modern ripper suite 12/12 passed; payload medium errors now enter the existing untrusted-sector recovery path while tested device/transport failures remain fatal; SCSI builds pass for net8/net47/net20; H: and K: completed full-disc reads and simultaneous inquiry/TOC; H: completed a full rip and two-read Test & Copy | repeat the damaged K: run beyond its former `NO SEEK COMPLETE` abort; broader drive, firmware, C2, cancellation, disagreement, and media-error matrices remain |
...
- 2026-07-27: recorded the 12/12 damaged-media policy suite, all three SCSI target
  builds, the 352/352 WPF suite, and the responsive Rip layout contract and
  1200-pixel loaded-disc evidence. The damaged K: rerun and final presentation
  matrix remain bounded external checks.
