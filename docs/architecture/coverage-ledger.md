...
| S14 Tests | `CUETools/CUETools.Test*/`, `TestRipper/`, `CUETools.TestHelpers/` | medium | mapped | owned-clear | MSTest usage verified; suites never executed in this engagement | 11 Step 2 (run, wire into CI) |
