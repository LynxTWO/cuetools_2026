...
- **Status:** implemented and partially live-verified through 2026-07-29. Provider identity,
  ...
  `docs/evidence/2026-08-26-selector-scaling/`; the high-contrast captures landed
  2026-08-27 under `docs/evidence/2026-08-27-selector-high-contrast/` and raised
  decision D14 (the app palette ignores the system scheme). TheAudioDB is available only as an off-by-default user-key
...
- **Status:** implemented and partially live-verified through 2026-07-29. Local JPEG/PNG/BMP
  ...
  High-contrast browser and picker captures landed 2026-08-27
  (`docs/evidence/2026-08-27-selector-high-contrast/`): the browser keeps its
  own palette and stays legible; the codec picker's ListView selection
  half-adopts the system highlight, white text on system cyan in the dark
  theme. Whether the app should honour the system scheme is decision D14.
